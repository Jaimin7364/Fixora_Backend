...
from app.api.v1 import auth_routes, ticket_routes, kb_routes, slack_routes, metrics_routes, user_routes, slack_oauth_routes
...
api_router.include_router(slack_oauth_routes.router)
